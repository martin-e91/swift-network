...
struct Target: Decodable, CustomStringConvertible {
    ...
    var description: String {
        "\(name)        |       \(String(format: "%.2f%%", coveragePercentage))"
    }
}
...
struct Arguments {
    ...
    init(fromCommandLineArgs _: [String]) {
        pathToCoverageFile = CommandLine.arguments[1]
        ...
        requiredCoverage = minimumCoverageValue
    }
}
